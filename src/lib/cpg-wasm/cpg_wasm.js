...
const ChordProgressionManagerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chordprogressionmanager_free(ptr >>> 0, 1));
...
export class ChordProgressionManager {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ChordProgressionManagerFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_chordprogressionmanager_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.chordprogressionmanager_new();
        this.__wbg_ptr = ret >>> 0;
        ChordProgressionManagerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {any} js_obj
     ...
     */
    loadConfig(js_obj) {
        const ret = wasm.chordprogressionmanager_loadConfig(this.__wbg_ptr, js_obj);
        return ret !== 0;
    }
    /**
     * @returns {string}
    ...
    calculateChordProgression() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.chordprogressionmanager_calculateChordProgression(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper869 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 53, __wbg_adapter_50);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cpg_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
